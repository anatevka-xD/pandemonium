...
public class CopperPedestalBlockEntityRenderer implements BlockEntityRenderer<CopperPedestalBlockEntity> {
    public CopperPedestalBlockEntityRenderer(BlockEntityRendererProvider.Context context) {

    };
    @Override
    public void render(CopperPedestalBlockEntity blockEntity, float partialTick, PoseStack poseStack,
