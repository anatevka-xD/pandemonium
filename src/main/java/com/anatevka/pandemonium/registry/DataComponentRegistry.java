...
public class DataComponentRegistry {
    ...
    public static final DeferredHolder<DataComponentType<?>, DataComponentType<CipherState>> CIPHER_DATA =
            register("cipher_state", builder -> builder.persistent(CipherState.CODEC));
