...
public class MenuRegistry {
    ...
    public static final Supplier<MenuType<EscritoireMenu>> ESCRITOIRE_MENU = MENUS.register(
            "escritoire_gui", () -> new MenuType<>(EscritoireMenu::new, FeatureFlags.DEFAULT_FLAGS));
